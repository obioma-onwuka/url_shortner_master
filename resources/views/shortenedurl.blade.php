                ...
                <div class="col-lg-7 text-center">
                    ...
                    <div class="wow fadeInUp text-center" data-wow-delay="0.3s">
                        ...
                        <div class="text-center mt-4">
                            <a class="btn btn-primary rounded-pill px-4 me-3" href="#">Sign In <small class="text-danger">coming soon</small></a>
                            <a class="btn btn-primary rounded-pill px-4 me-3" href="#">Sign Up <small class="text-danger">coming soon</small></a>
                        </div>
                    </div>
                </div>
            </div>
