                        ...
                        <form>
                            ...
                            <div class="row g-3">
                                <div class="col-12 text-justify">
                                    ...
                                    {{-- <p>Password Length: {{$useLength}}</p>
                                    <p>Strength @if {{$useLength <= 9}} : <span class = "text-secondary">Average</span> @elseif {{$useLength <= 11}}: <span class = "text-primary">Medium</span> @else <span class = "text-success">High</span>@endif</p> --}}
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-floating">
                                        ...
                                        <input type="text" class="form-control" id='myInput' readonly value = "{{ $randomlyGenerated }}">
                                ...
                                <div class="col-12">
                                    ...
                                    <a href="/generate_password" class="btn btn-primary">Generate Again</a>
                                </div>
                            </div>
                        </form>
                    </div>
